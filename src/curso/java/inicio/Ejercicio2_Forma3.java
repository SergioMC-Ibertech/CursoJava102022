...
public class Ejercicio2_Forma3 {
	...
	static void gestionAlumnos(String colegio[][], String accion) {
		...
		}else if(accion.equals(MOSTRARAULA)) {
			buscarAlumnosAula(colegio);
		}else if(accion.equals(COLEGIO)) {
			todosAlumnos(colegio);
		}
	}
	...
	static void buscarAlumnosAula(String colegio[][]) {
		int aula = Utils_Ejercicio2.pedirNumero("Dime en que aula quieres insertar al alumno/a: ");
		for(int i=0; i<colegio.length; i++) {
